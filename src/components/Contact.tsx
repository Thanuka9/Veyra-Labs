              ...
              <div>
                ...
                <div className="mt-8 rounded-xl border border-border bg-surface/60 p-4">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-muted">
                    AI-driven forecasting kernels achieving{" "}
                    <strong className="text-foreground">R² &gt; 0.90</strong> and{" "}
                    <strong className="text-foreground">40% reduction</strong> in manual audit
                    overhead across enterprise RCM workflows  -  Collective RCM.
                  </p>
                </div>
              </div>
            </Reveal>
              ...
              <Reveal delay={1}>
                ...
                >
                  ...
                  <button
                    ...
                    className="group relative mt-1 inline-flex items-center justify-center gap-2 overflow-hidden rounded-xl bg-gradient-to-r from-violet to-cyan px-6 py-4 text-sm font-semibold text-white shadow-[0_0_32px_-8px_rgba(124,92,255,0.6)] transition-all hover:scale-[1.02] hover:shadow-[0_0_48px_-6px_rgba(124,92,255,0.85)] disabled:cursor-not-allowed disabled:opacity-60"
                  >
